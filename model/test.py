...
if __name__ == '__main__':
    ...
    parser.add_argument('--checkpoint', type = str, default = data_path+'checkpoints20210824/', help = '存档地址')
    ...
    parser.add_argument('--conf_thres', type = float, default = .5, help = '交叉验证置信度阈值')
    parser.add_argument('--nms_thres', type = float, default = .5, help = '交叉验证nms阈值')
    ...
    parser.add_argument('--mini_batch', type = int, default = 16, help = 'mini批数量')
